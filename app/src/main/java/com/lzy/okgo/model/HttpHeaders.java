...
public class HttpHeaders implements Serializable {
    ...
    public static String getUserAgent() {
        if (TextUtils.isEmpty(userAgent)) {
            ...
            String userAgentTemp = System.getProperty("http.agent");//Dalvik/2.1.0 (Linux; U; Android 6.0.1; vivo X9L Build/MMB29M)

            for (int i = 0, length = userAgentTemp.length(); i < length; i++) {
                char c = userAgentTemp.charAt(i);
                if (c <= '\u001f' || c >= '\u007f') {
