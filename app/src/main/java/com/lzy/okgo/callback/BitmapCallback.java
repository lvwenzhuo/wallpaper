...
public abstract class BitmapCallback extends AbsCallback<Bitmap> {
    ...
    public BitmapCallback(Context context, int maxWidth, int maxHeight) {
        super(context);
        convert = new BitmapConvert(maxWidth, maxHeight);
    }

    public BitmapCallback(Context context, int maxWidth, int maxHeight, Bitmap.Config decodeConfig, ImageView.ScaleType scaleType) {
        super(context);
