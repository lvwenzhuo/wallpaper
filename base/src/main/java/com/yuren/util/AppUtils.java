...
public final class AppUtils {
    ...
    public static int getInternalReflactField( String fieldName){
        return getReflactField("com.android.internal.R$id", fieldName);
    }
     ...
     */
    public static boolean isInstallApp(final Context context, final String packageName) {
     ...
     */
    public static void installApp(final Context context, final String filePath, final String authority) {
     ...
     *                  <br>参看https://developer.android.com/reference/android/support/v4/content/FileProvider.html
     */
    public static void installApp(final Context context, final File file, final String authority) {
     ...
     */
    public static boolean installAppSilent(final Context context, final String filePath) {
    ...
    public static void uninstallApp(final Context context, final String packageName) {
        if (context == null || isSpace(packageName)) {
            return;
        }
     ...
     */
    public static boolean uninstallAppSilent(final Context context, final String packageName, final boolean isKeepData) {
        if (isSpace(packageName)) {
            return false;
        }
     ...
     * 获取App具体设置
     */
    public static void getAppDetailsSettings(final Context context) {
     ...
     * @param packageName 包名
     */
    public static void getAppDetailsSettings(final Context context, final String packageName) {
        if (context == null || isSpace(packageName)) {
            return;
        }
     ...
     * @return 当前应用的AppInfo
     */
    public static AppInfo getAppInfo(final Context context) {
     ...
     * @return 当前应用的AppInfo
     */
    public static AppInfo getAppInfo(final Context context, final String packageName) {
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
     ...
     */
    public static List<AppInfo> getAppsInfo(final Context context) {
     ...
     */
    public static boolean cleanAppData(final Context context, final String... dirPaths) {
     ...
     * @return {@code true}: 成功<br>{@code false}: 失败
     */
    public static boolean cleanAppData(final Context context, final File... dirs) {
    ...
    public static Boolean isMainApplication(final Application application) {
