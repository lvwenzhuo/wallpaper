...
public final class ProcessUtils {
     ...
     * @return 前台应用包名
     */
    public static String getForegroundProcessName(final Context context) {
     ...
     * @return 后台服务进程
     */
    public static Set<String> getAllBackgroundProcesses(final Context context) {
     ...
     * @return 被暂时杀死的服务集合
     */
    public static Set<String> killAllBackgroundProcesses(final Context context) {
        ActivityManager am = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
        Set<String> set = new HashSet<>();
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
     ...
     */
    public static boolean killBackgroundProcesses(final Context context, @NonNull final String packageName) {
        ActivityManager am = (ActivityManager) context.getSystemService(Context.ACTIVITY_SERVICE);
        List<ActivityManager.RunningAppProcessInfo> info = am.getRunningAppProcesses();
